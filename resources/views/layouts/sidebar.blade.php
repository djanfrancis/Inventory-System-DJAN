<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="{{ route('categories.index') }}"><i class="fa fa-list"></i> <span>Warehouses</span></a></li>
            <li><a href="{{ route('products.index') }}"><i class="fa fa-cubes"></i> <span>Products</span></a></li>
            ...
            <li><a href="{{ route('user.index') }}"><i class="fa fa-user-secret"></i> <span>Users</span></a></li>
